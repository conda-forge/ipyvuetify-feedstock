...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ipyvuetify-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ipyvuetify-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install ipyvuetify
```
...
It is possible to list all of the versions of `ipyvuetify` available on your platform:
...
```
pixi search ipyvuetify --channel conda-forge
```
